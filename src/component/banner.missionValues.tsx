          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                We show up on time, every time, and deliver what we promise. Your trust is our most valuable asset.
              </p>
            </div>
            <div className="text-center">
              <div className="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">
                We treat your belongings with the same care we would our own. Every item matters to us.
              </p>
            </div>
            <div className="text-center">
              <div className="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">
                Exceptional customer service is at the heart of everything we do. Your satisfaction is our priority.
              </p>
            </div>
          </div>
        </div>
...
MissionValues.displayName = 'MissionValues';
