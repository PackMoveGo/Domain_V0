...
export default function ApiFailureModal({ isVisible, onClose, failureDetails }: ApiFailureModalProps) {
  ...
  const handleReportBug = () => {
    const reportUrl = 'https://report.packmovego.com';
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-red-100 text-xs opacity-75">
                    {failureDetails ? `[API Failed: ${failureDetails.endpoint}]` : 
                     (process.env.NODE_ENV === 'development' ? '[DevTools Triggered]' : '[Service Unavailable]')}
                  </p>
                </div>
              </div>
              <button
              ...
              <div className="text-gray-600 mb-4">
                ...
                {failureDetails && (
                  <div className="mt-3 p-3 bg-red-50 border border-red-200 rounded-lg">
                    <p className="text-xs text-red-700 font-medium mb-1">Technical Details:</p>
