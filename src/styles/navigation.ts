export const navigationStyles = {
  ...
  mobileBottom: {
    ...
    overlay: 'fixed inset-0 bg-black bg-opacity-25 transition-opacity duration-300 ease-in-out z-40',
    panel: 'fixed right-0 top-0 bottom-0 bg-white shadow-2xl overflow-y-auto flex flex-col z-50 transform transition-transform duration-300 ease-in-out w-80 max-w-[85vw]',
